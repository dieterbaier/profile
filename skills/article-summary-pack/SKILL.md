...
description: Create paste-ready summaries, teasers, excerpts, and short publication drafts from project articles for LinkedIn, Substack, and listed.io. Use when an agent is asked to summarize an article, prepare social posts, generate cross-posting copy, apply article-summary templates, or work with the AI contract for article summaries in this repository.
---
...
- LinkedIn: read `templates/article-summary-pack/linkedin.md`.
- Substack: read `templates/article-summary-pack/substack.md`.
- listed.io: read `templates/article-summary-pack/listed-io.md`.

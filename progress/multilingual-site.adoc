...
Docs-as-Code-Artikel und den Listen. Ein Sprachumschalter sitzt auf jeder Seite
links von „Home"; seine Flaggen stehen seit #100 nicht mehr als Zeichen im
Markup, sondern werden vom Stylesheet als Inline-SVG gezeichnet, adressiert über
die Klasse `flag-<lang>`. Verweise fallen auf Deutsch zurück und sagen es mit
...
* Die Sprachprüfung auf `plantuml::`-Quellen (#70). Wo diese Quellen liegen und
  wie ein sprachneutrales Diagramm erkannt wird, hat PR #97 entschieden; offen
  ist nur noch die Prüfung selbst.

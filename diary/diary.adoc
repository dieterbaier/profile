...
„Ich" ist durchgehend der Autor dieses Repositories. Die Prosa entsteht zu einem
großen Teil mit einem AI-Assistenten und wird hier auch nicht anders behauptet;
wo der Unterschied zwischen Autor und Assistent die Lehre trägt, steht „der
Assistent" im Text. Das letzte Wort über jeden Eintrag hat der Autor.
...
include::2026-08-05-die-antwort-lag-schon-da.adoc[]

include::2026-08-15-was-der-build-nie-sieht.adoc[]

include::2026-08-29-die-gerichtete-pruefung.adoc[]

include::2026-09-07-hingeschrieben-und-still-verworfen.adoc[]

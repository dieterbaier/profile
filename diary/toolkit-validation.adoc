...
Zum Vergleich für ein Issue stromaufwärts, das es noch nicht gibt: im Profil
liegt die akzeptierte Menge als `enum` am Feld im Schema, der Validator liest sie
aus dem eigenen Checkout statt aus dem Baum, auf den er gezeigt wird, und ein
fehlender Wert ist ein Fehler und nicht die Ausgangsversion.

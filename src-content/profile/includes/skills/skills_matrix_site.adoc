...
ifndef::nolinks[]
        <a href="{basedir}/articles/architecture/sustainability.html"><strong>{skill_architecture_title}</strong></a>
endif::[]
<br>
...
ifndef::nolinks[]
        <a href="{basedir}/articles/architecture/smarte-cicd-pipeline.html">{skill_platform_cicd}</a>
endif::[]
        {skill_platform_4}<br>
    </div>
</div>
